...
class SCCGC(nn.Module):
    ...
    def __init__(self, ae_n_enc_1, ae_n_enc_2, ae_n_enc_3,
                 ...
                 n_input, n_z, n_clusters, v, device):
        super(SCCGC, self).__init__()
        ...
        ae_pre = 'E:/ae_pretrain/{}.pkl'.format(args.name)
    ...
    def forward(self, x, adj):
        ...
        return x_bar, z_hat, adj_hat, z_ae, q, q1, z_l, enc_h3
